...
`;
  ...
  loadSinglePDFFile(pdfFile) {
    return __async(this, null, function* () {
      ...
      yield loadPDFFile(PDFFile.convertTFileToPDFFile(pdfFile, content), pdfjsLib, containingFolder, grandtotal, desiredAnnotations);
      ...
      yield this.saveHighlightsToFileAndOpenIt(filePathOfExportNote, finalMarkdown);
    });
  }
  ...
  saveHighlightsToFileAndOpenIt(filePath, mdString) {
    return __async(this, null, function* () {
      ...
      if (fileExists) {
        ...
        try {
          ...
          console.error(error);
          new import_obsidian2.Notice("Error creating note with annotations, because the notes export path is invalid. Please check the file path in the settings. Folders must exist.");
        }
      }
    });
  }
